...
if __name__ == '__main__':
    annFile = '../wsml2022/data/coco/annotations/instances_train2014.json'
    mask_path = '../wsml2022/data/coco/mask/train2014'
    ...
    annFile = '../wsml2022/data/coco/annotations/instances_val2014.json'
    mask_path = '../wsml2022/data/coco/mask/val2014'
    os.makedirs(mask_path, exist_ok=True)
    coco = COCO(annFile)
    ids = list(coco.imgs.keys())
    print(len(ids))
