...
def _work(process_id, infer_dataset, args):
    ...
    for iter, pack in enumerate(infer_data_loader):
        ...
        try:
            ...
            fg_conf_cam = np.pad(cams, ((1, 0), (0, 0), (0, 0)), mode='constant', constant_values=args.amn_conf_fg_thres)
            ...
            fg_conf = keys[pred]
            bg_conf_cam = np.pad(cams, ((1, 0), (0, 0), (0, 0)), mode='constant', constant_values=args.amn_conf_bg_thres)
