...
def run(args):
    ...
    model = getattr(importlib.import_module(args.amn_network), 'Net')(coco=True)
    ...
    train_dataset.label_list = np.load(os.path.join(args.work_space, 'activated_class_labels.npy'))
