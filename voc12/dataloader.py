...
single_positive_cls_labels_dict = np.load('voc12/single_positive_cls_labels.npy', allow_pickle=True).item()
...
class VOC12SinglePositiveClassificationDataset(VOC12ImageDataset):
